                    ...
                    <li class="nav-item mx-3">
                        ...
                        <div class="collapse" id="Recursos_Humanos">
                            <ul class="submenu list-unstyled ps-3">
                                ...
                                <li><a href="registro_ade_desc_colaborador" class="nav-link text-white"><i class="fa-solid fa-book"></i> &nbsp;Registro de Adelantos y Descuentos</a></li>
                                <li><a href="control_asistencia_colaborador" class="nav-link text-white"><i class="fa-solid fa-book"></i> &nbsp;Control de Asistencia</a></li>
